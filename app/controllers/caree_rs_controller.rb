class CareeRsController < ApplicationController
  ...
  private
    ...
    def career_params
      params.require(:career).permit(:ID, :TITLE, :LEVEL_EDUCATION, :MODALITY, :DURATION, :WORKING_DAY, :VALUE_SEMESTER, :VALUE_CURRICULUM, :QUALIFIED_REGISTRATION, :NUM_CREDITS, :AREA_KNOWLEDGE, :INFO_ADDITIONAL)
    end
end
