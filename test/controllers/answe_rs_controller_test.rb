...
class AnsweRsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { ANSWER_VOTED: @answer.ANSWER_VOTED, ID: @answer.ID } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { ANSWER_VOTED: @answer.ANSWER_VOTED, ID: @answer.ID } }
