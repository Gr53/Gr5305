...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post branches_url, params: { branch: { address: @branch.address, institution_id: @branch.institution_id, locality: @branch.locality, location_map: @branch.location_map, name: @branch.name } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { address: @branch.address, institution_id: @branch.institution_id, locality: @branch.locality, location_map: @branch.location_map, name: @branch.name } }
